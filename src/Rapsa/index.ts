...
class Rapsa {
    ...
    addAmount(amount: string | number) {
        ...
        this.params.a = BaseConverter.base10ToBase62(amount);
        return this;
    }
    ...
    addBornaTrxId(bornaTrxId: string) {
        ...
        this.params.b = BaseConverter.base10ToBase62(bornaTrxId);
        return this;
    }
    ...
    addInvoiceId(invoiceId: string | number) {
        ...
        this.params.i = BaseConverter.base10ToBase62(invoiceId);
        return this;
    }
    ...
    addPaymentId(paymentId: string | number) {
        ...
        this.params.p = BaseConverter.base10ToBase62(paymentId);
        return this;
    }
    ...
    static parse(uri: { split: (arg0: string) => [any, any]; }) {
        ...
        if (queryString) {
            queryString.split('&').forEach((param: { split: (arg0: string) => [string, string]; }) => {
     ...
     */
    getCards() {
        return this.params.c ? this.params.c.map((encoded: string) => new CardNumber(encoded)) : [];
    }
     ...
     */
    getShebas() {
        return this.params.s ? this.params.s.map((encoded: string) => new Sheba(encoded)) : [];
    }
     ...
     */
    getWallets() {
        return this.params.w ? this.params.w.map((encoded: string) => new WalletAddress(encoded)) : [];
    }
